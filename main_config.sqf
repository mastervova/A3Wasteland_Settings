...
A3W_timeMultiplierNight = 28.0;     // Sets the speed of time between 8 PM and 5 AM
...
A3W_atmMaxBalance = 50000000;       // Maximum amount of money that can be stored in a bank account (recommended: 1 million)
